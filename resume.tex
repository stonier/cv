...
\begin{cvsection}{Relevant Experience}
  ...
  \cvheaderinfo{Innovation Team Co-Leader}{2014-2016}
    ...
    \cvitem{Network}{successfully connected with partners internationally and locally}
    \cvitem{Prototypes}{manage rapid design and iteration on product ideas (seeing is believing!)}
    \cvitem{Demonstrations}{prepared systems for successful shows and field tests at client facilities}
    ...
    \cvitem{Behaviour Trees}{built a comprehensive behaviour trees implementation to handle decision making logic inside the robot}
  ...
  \cvheaderinfo{Kobuki Project Lead}{2012-2016}
    ...
    \cvitem{Successes}{thousands of users, increasing sales every year \& thriving groups around spin-off platforms (\href{http://wiki.ros.org/Robots/TurtleBot}{turtlebot}, \href{https://www.autonomous.ai/deep-learning-robot}{deepbot} \& \href{http://www.quanser.com/products/qbot2}{qbot})}
...
\begin{cvsection}{References}
  ...
  \cvheader{Sam Park}{CTO, Yujin Robot}
    ...
    \cvitem{Phone}{<TODO>}
  \cvheader{\href{https://www.linkedin.com/in/marcusliebhardt/en}{Marcus Liebhardt}}{Innovation Team Co-Leader, Yujin Robot}
    \cvitem{Email}{ich@marcusliebhardt.de}
    \cvitem{Phone}{<TODO>}
  \cvheader{\href{http://www.osrfoundation.org/team/brian-gerkey/}{Brian Gerkey}}{CEO, Open Source Robotics Foundation}
    \cvitem{Capacity Known}{Collaborated on projects, shared time on business trips, co-organised ROSCon 2016}
    \cvitem{Email}{gerkey@osrfoundation.org}
    \cvitem{Phone}{<TODO>}
  \cvheader{\href{https://www.linkedin.com/in/naveen-kuppuswamy-5913808}{Naveen Kuppuswamy}}{Robotics Researcher, TRI}
